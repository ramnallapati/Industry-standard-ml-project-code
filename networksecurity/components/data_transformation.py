...
class DataTransformation:
  def __init__(self,data_validation_artifact:DataValidationArtifact,data_transformation_config:DataTransformationConfig):
    ...
    try:
      self.data_validation_artifac:DataValidationArtifact = data_validation_artifact
  ...
  def initiate_data_transformation(self)->DataTransformationArtifact:
    ...
    try:
      ...
      train_df = self.read_data(self.data_validation_artifac.valid_train_file_path)
      test_df = self.read_data(self.data_validation_artifac.valid_test_file_path)
